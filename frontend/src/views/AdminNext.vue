...
const workspaceModel = computed(() => ({
    ...
    visibleMailRows: visibleMailRows.value,
    mailPage: mailPage.value,
    totalMailPages: totalMailPages.value,
    mailPageSize: mailPageSize.value,
    canPrevPage: canPrevMailPage.value,
    canNextPage: canNextMailPage.value,
    mailTotalCount: live.mailTotalCount,
    mailRowCount: mailRows.value.length,
    filteredUnknownRows: filteredUnknownRows.value,
    mailRows: mailRows.value,
    isAllVisibleSelected: isAllVisibleSelected.value,
    isSomeVisibleSelected: isSomeVisibleSelected.value,
    selectedMailCount: selectedMailCount.value,
    selectedMailRows: selectedMailRows.value,
    selectedMailIds: selectedMailIds.value,
    currentRail: currentRail.value,
    currentMail: currentMail.value,
    currentRendererMail: currentRendererMail.value,
    isDetailParsing: isDetailParsing.value,
